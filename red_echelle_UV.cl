procedure red_echelle_UV (inimages, outimages, tharimages)
...
#      ccdproc("dumc",output="dumd",fixpix=no, overscan=yes, biassec="[1:2,2:2046]")
      ...
      imarith("dume","/","flat_final","dumf"+"_"+in,pixtype="real",calctyp="real")      
      imdelete("dume",verify=no)
      print(" ")
      print("removing scattered light")
      print(" ")
      apscatter("dumf"+"_"+in,"dumi",referen="orders_UV", line=1024, find=yes, recente=yes)
      print (" ")
